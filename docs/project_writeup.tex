...
The Android system resolves intents sent to other devices
...
\texttt{MobileIntentHandler.registerProvider} with the constraint as
an argument.
...
public class EmailReceiver extends BroadcastReceiver {
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    String mAddress = getStringExtra(``recepient'');
    String mBody = getStringExtra(``body'');
    // Send email using recepient and body...
  }
} 
\end{lstlisting}
...
field of mobile routing.  We plan to consider 
